...
对于高考这样的笔试考试，我们训练的内容都是从题干（输入）到答案（输出）的一一映射。判断优劣的标准是答案和标准答案/参考答案之间的相似性。由于备考时间有限，备学知识无限，高效地优化这个映射函数的策略（高效的学习方法）是取得优秀成绩的关键所在。

据作者的观察，很多学校虽然对学生进行学习时间上的高强度压榨，但是无法有效地优化学生的学习方法，无法有效解决学生进入学习的瓶颈期/平台期的现象。作者将学生的学习方法没有得到改善，在经过一段时间的学习后学习成绩开始趋于稳定的现象成为学习的饱和现象。相应地，将在学习饱和后不改变原学习方法继续学习的现象称为过饱和学习。作者为这种现象提供一种解释：原学习方法导致（所学知识对应的）大脑神经元连接强度的平均水平不够强，以至于在后期继续学习时，前期知识的遗忘速率（神经元连接的破坏速率）达到接近甚至超过新学知识的记忆速率（神经元连接的加强速率），从而导致总体知识水平停滞不前。此外，一些固有的系统偏差，如解题速度偏低、失误率高等现象也可能会导致学习成绩出现饱和。作者将在下文对此一一给出自己的建议。
